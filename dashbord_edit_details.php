...
?>
			...
			<div class="header text-center">
                ...
                <form  action="dashbord_reported.php" method="post">
<div class="row">
	...
	<div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" name="lng" class="form-control" placeholder="longtitude" >
        </div>
    </div>

	<button type="submit" class="btn btn-info btn-fill pull-right"  >ADD TO DASHBOARD</button>
